...
import { ArrowUpRight, BriefcaseBusiness, Code2, GitBranch, Mail, Menu, MoveUpRight, Phone, X } from 'lucide-react'
...
function App() {
  ...
  return (
    <main>
      ...
      <section id="certifications" className="certifications-section page-shell"><Reveal className="section-heading"><div><p className="section-label">04 / Certifications</p><h2>Learning that<br /><span>keeps moving.</span></h2></div><p className="flip-hint">Hover a card for details</p></Reveal><div className="certification-grid">{certifications.map((certification) => <Reveal key={certification.number}><article className="certification-card" tabIndex="0"><img className="certification-image" src={certification.image} alt={`${certification.name} certificate`} /><div className="certification-card-content"><div className="certification-top"><span className="project-number">{certification.number}</span><span className="certification-date">{certification.date}</span></div><h3>{certification.name}</h3><p className="certification-issuer">{certification.issuer}</p><div className="certification-detail"><p>{certification.detail}</p><button className="certificate-button" type="button" onClick={() => setSelectedCertification(certification)}>View certificate <ArrowUpRight size={14} /></button></div></div></article></Reveal>)}</div></section>
      ...
      <section id="contact" className="contact-section page-shell"><Reveal><p className="section-label">05 / Contact</p><h2>Wanna say <em>hi to me?</em></h2><a className="contact-link" href="mailto:adityas08102006@gmail.com">adityas08102006@gmail.com <ArrowUpRight size={22} /></a><a className="contact-link phone-link" href="tel:+916377823453"><Phone size={19} /> +91 6377823453 <ArrowUpRight size={22} /></a></Reveal></section>
